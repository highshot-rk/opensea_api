...
const MNEMONIC = "metamask" || process.env.MNEMONIC;
const NODE_API_KEY = "DPjBwRzBYFN-_eNbZ-X4Eq4UuK38wpsi" || process.env.INFURA_KEY || process.env.ALCHEMY_KEY;
...
module.exports = {
  networks: {
    development: {
      host: "localhost",
      from: "0x5d73dD8A58dE24c756B661730BE14ef0C762F935",
      port: 8545,
      gas: 5000000,
