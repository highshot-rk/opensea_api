...
contract OwnableMineDelegateProxy { }

contract ProxyMineRegistry {
  mapping(address => OwnableMineDelegateProxy) public proxies;
}
...
contract ERC1155Tradable is ContextMixin, ERC1155, NativeMetaTransaction, Ownable {
  ...
  function isApprovedForAll(
    ...
    ProxyMineRegistry proxyRegistry = ProxyMineRegistry(proxyRegistryAddress);
